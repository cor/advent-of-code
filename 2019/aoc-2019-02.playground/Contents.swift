...
func executeIntcode(program inputProgram: IntcodeProgram) -> IntcodeProgram {
    ...
    while (running && instructionPointer < program.count)
    {
        ...
        instructionPointer += 4 // Go to next instruction
    }
...
// First Half Answer
executeIntcode(program: challangeInput)[0]

// MARK: - PART TWO
func find19690720combo () -> Int? {
    // Brute force
    for noun in 0...99 {
        for verb in 0...99 {
            var challangeInputCopy = challangeInput
            challangeInputCopy[1] = noun
            challangeInputCopy[2] = verb
            
            if executeIntcode(program: challangeInputCopy)[0] == 19690720 {
                // Ladies and gentlemen, we got him.
                return 100 * noun + verb
            }
        }
    }
    return nil // The challange is broken
}
